 ...
 * @see https://github.com/microsoft/DirectXTK12/wiki/The-basic-game-loop
 ...
 *  - Use `std::runtime_error` instead of `std::exception` for error handling
 *  - Move default values to member initializers
